    ...
    <nav className="bg-gray-800 fixed  w-full">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline">
                ...
                <a href="#about" className="ml-4 px-3 py-2 rounded-md text-xl font-medium text-gray-300 duration-200 hover:text-white hover:bg-gray-700 ">About</a>
                <a href="#portfolio" className="ml-4 px-3 py-2 rounded-md text-xl font-medium text-gray-300 duration-200 hover:text-white hover:bg-gray-700 ">Portfolio</a>
                <a href="#experince" className="ml-4 px-3 py-2 rounded-md text-xl font-medium text-gray-300 duration-200 hover:text-white hover:bg-gray-700">Experience</a>
                <a href="#contact" className="ml-4 px-3 py-2 rounded-md text-xl font-medium text-gray-300 duration-200 hover:text-white hover:bg-gray-700">Contact</a>
              </div>
            </div>
          </div>
      ...
      <div className={`${expanded ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <a href="#portfolio" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">Portfolio</a>
          <a href="#experince" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">Experience</a>
